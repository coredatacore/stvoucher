    ...
    <div id="wrapper">
        ...
        <aside id="sidebar">
            ...
            <div class="sidebar-nav">
                ...
                <a href="<?php echo e(route('admin.sites.index')); ?>" class="sidebar-link <?php echo e(request()->routeIs('admin.sites.*') ? 'active' : ''); ?>">
                    <i class="bi bi-building"></i> <span>Sites</span>
                </a>
                <a href="<?php echo e(route('admin.nas.index')); ?>" class="sidebar-link <?php echo e(request()->routeIs('admin.nas.*') ? 'active' : ''); ?>">
                    <i class="bi bi-hdd-network"></i> <span>NAS & Clients</span>
                </a>

                <div class="nav-section">Voucher Engine</div>
                <a href="<?php echo e(route('admin.profiles.index')); ?>" class="sidebar-link <?php echo e(request()->routeIs('admin.profiles.*') ? 'active' : ''); ?>">
                    <i class="bi bi-tags"></i> <span>Profiles</span>
                </a>
                <a href="<?php echo e(route('admin.vouchers.index')); ?>" class="sidebar-link <?php echo e(request()->routeIs('admin.vouchers.*') ? 'active' : ''); ?>">
                    <i class="bi bi-ticket-perforated"></i> <span>Vouchers</span>
                </a>

                <div class="nav-section">Monitoring & Logs</div>
                <a href="<?php echo e(route('admin.sessions.index')); ?>" class="sidebar-link <?php echo e(request()->routeIs('admin.sessions.*') ? 'active' : ''); ?>">
                    <i class="bi bi-people"></i> <span>Active Users</span>
                </a>
                <a href="<?php echo e(route('admin.logs.accounting')); ?>" class="sidebar-link <?php echo e(request()->routeIs('admin.logs.accounting') ? 'active' : ''); ?>">
                    <i class="bi bi-journal-text"></i> <span>Accounting</span>
                </a>
                <a href="<?php echo e(route('admin.logs.auth')); ?>" class="sidebar-link <?php echo e(request()->routeIs('admin.logs.auth') ? 'active' : ''); ?>">
        ...
        <div id="content-wrapper">
                    ...
                    <div class="dropdown">
                        <div class="user-profile" data-bs-toggle="dropdown" aria-expanded="false">
                            <div class="user-info text-end">
                                <span class="user-name"><?php echo e(auth()->user()->name ?? 'Administrator'); ?></span>
                                <span class="user-role"><?php echo e(auth()->user()->role ?? 'Admin'); ?></span>
                            </div>
            ...
            <main class="page-content fade-in">
                <div class="page-header d-flex justify-content-between align-items-center flex-wrap gap-3">
                    <h2 class="page-title"><?php echo $__env->yieldContent('header', 'Dashboard'); ?></h2>
...
</html><?php /**PATH C:\laragon\www\radiusserver\resources\views/layouts/app.blade.php ENDPATH**/ ?>