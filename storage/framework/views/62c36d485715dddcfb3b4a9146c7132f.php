<?php $__env->startSection('header', 'Sites Management'); ?>
...
<div class="card border-0 bg-white p-4">
        ...
        <table class="table table-hover datatable align-middle mb-0 w-100">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="font-monospace text-muted"><?php echo e($site->site_code); ?></td>
                    <td><?php echo e($site->location ?? 'N/A'); ?></td>
                    <td><span class="badge bg-light text-dark border"><i class="bi bi-wifi me-1"></i><?php echo e($site->ssid_name ?? 'N/A'); ?></span></td>
                    <td>
                        <span class="badge rounded-pill <?php echo e($site->status == 'active' ? 'bg-success bg-opacity-10 text-success' : 'bg-danger bg-opacity-10 text-danger'); ?> px-3 py-2">
                            <i class="bi <?php echo e($site->status == 'active' ? 'bi-check-circle' : 'bi-x-circle'); ?> me-1"></i><?php echo e(ucfirst($site->status)); ?>

                        </span>
                    </td>
                    <td class="text-end">
                        <form action="<?php echo e(route('admin.sites.destroy', $site->id)); ?>" method="POST" class="d-inline">
                            <?php echo csrf_field(); ?>
    ...
    <div class="mt-4 d-flex justify-content-end">
        <?php echo e($sites->links('pagination::bootstrap-5')); ?>
...
<div class="modal fade" id="addSiteModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content border-0 shadow-lg">
            ...
            <form action="<?php echo e(route('admin.sites.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\radiusserver\resources\views/admin/sites/index.blade.php ENDPATH**/ ?>