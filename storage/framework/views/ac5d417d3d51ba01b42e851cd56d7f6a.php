...
<body class="p-4 p-md-5">
    <div class="no-print mb-5 bg-white p-4 rounded-3 shadow-sm border d-flex justify-content-between align-items-center">
        ...
        <div class="d-flex gap-3">
            ...
            <select class="form-select form-select-sm w-auto"><option>All Groups</option></select>
                ...
                <div class="col-6 col-md-4">
                    <div class="voucher-card p-3 text-center">
                        ...
                        <div class="d-flex justify-content-between text-muted mb-2 px-1" style="font-size: 0.65rem;">
                            <span><?php echo e($voucher->site->site_name ?? 'Global'); ?></span>
                            <span><?php echo e($voucher->site->ssid_name ?? 'WiFi'); ?></span>
                        </div>

                        <p class="mb-3 border-bottom pb-2" style="font-size: 0.7rem; color: #495057;">
                            <span class="fw-bold">Group:</span> <?php echo e($voucher->group->group_name ?? 'N/A'); ?> <br>
                            <?php echo e($voucher->profile->profile_name ?? 'Custom Profile'); ?>

                        </p>
                        
                        <div class="bg-light py-2 mb-3 rounded border">
                            <span class="font-monospace fw-bold fs-5 tracking-widest text-dark"><?php echo e($voucher->voucher_code); ?></span>
                        </div>
                        
                        <div class="d-flex justify-content-between fw-bold text-dark px-2 mb-2" style="font-size: 0.75rem;">
                            <span>₱<?php echo e(number_format($voucher->price, 2)); ?></span>
                            <span><?php echo e(floor($voucher->duration_seconds / 3600)); ?> Hrs</span>
                        </div>
...
</html><?php /**PATH C:\laragon\www\radiusserver\resources\views/admin/vouchers/print.blade.php ENDPATH**/ ?>