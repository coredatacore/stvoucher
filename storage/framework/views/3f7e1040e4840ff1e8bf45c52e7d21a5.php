...
<?php $__env->startSection('actions'); ?>
    <div class="dropdown d-inline-block">
        ...
        <ul class="dropdown-menu dropdown-menu-end shadow border-0 mt-2">
            <li><a class="dropdown-item py-2" href="<?php echo e(route('admin.sites.index')); ?>"><i class="bi bi-building me-2 text-muted"></i>Create Site</a></li>
            <li><a class="dropdown-item py-2" href="<?php echo e(route('admin.vouchers.index')); ?>"><i class="bi bi-ticket-perforated me-2 text-muted"></i>Generate Voucher</a></li>
            <li><a class="dropdown-item py-2" href="<?php echo e(route('admin.nas.index')); ?>"><i class="bi bi-hdd-network me-2 text-muted"></i>Add NAS</a></li>
            <li><hr class="dropdown-divider"></li>
            <li><a class="dropdown-item py-2" href="#"><i class="bi bi-file-earmark-arrow-up me-2 text-muted"></i>Import CSV</a></li>
            <li><a class="dropdown-item py-2" href="<?php echo e(route('admin.reports.index')); ?>"><i class="bi bi-file-earmark-arrow-down me-2 text-muted"></i>Export Report</a></li>
    ...
    <div class="col-sm-6 col-lg-3">
        <div class="card card-hover h-100 border-0 bg-white position-relative overflow-hidden">
            ...
            <div class="card-body p-4">
                ...
                <h2 class="fw-black mb-0 text-dark counter"><?php echo e($stats['total_sites']); ?></h2>
            </div>
    ...
    <div class="col-sm-6 col-lg-3">
        <div class="card card-hover h-100 border-0 bg-white position-relative overflow-hidden">
            ...
            <div class="card-body p-4">
                ...
                <h2 class="fw-black mb-0 text-dark counter"><?php echo e($stats['active_sessions'] ?? 0); ?></h2>
            </div>
    ...
    <div class="col-sm-6 col-lg-3">
        <div class="card card-hover h-100 border-0 bg-white position-relative overflow-hidden">
            ...
            <div class="card-body p-4">
                ...
                <h2 class="fw-black mb-0 text-dark counter"><?php echo e($stats['total_profiles'] ?? 0); ?></h2>
            </div>
            <div class="position-absolute bottom-0 start-0 w-100 bg-danger" style="height: 4px;"></div>
        </div>
    </div>
    ...
    <div class="col-sm-6 col-lg-3">
        <div class="card card-hover h-100 border-0 bg-white position-relative overflow-hidden">
            ...
            <div class="card-body p-4">
                ...
                <h2 class="fw-black mb-0 text-dark counter"><?php echo e($stats['total_vouchers']); ?></h2>
            </div>
    ...
    <div class="col-sm-6 col-lg-3">
        <div class="card card-hover h-100 border-0 bg-white position-relative overflow-hidden">
            ...
            <div class="card-body p-4">
                ...
                <h2 class="fw-black mb-0 text-dark counter"><?php echo e($stats['online_users'] ?? 0); ?></h2>
            </div>
    ...
    <div class="col-sm-6 col-lg-3">
        <div class="card card-hover h-100 border-0 bg-white position-relative overflow-hidden">
            ...
            <div class="card-body p-4">
                ...
                <h2 class="fw-black mb-0 text-dark counter"><?php echo e($stats['unused_vouchers']); ?></h2>
            </div>
    ...
    <div class="col-sm-6 col-lg-3">
        <div class="card card-hover h-100 border-0 bg-white position-relative overflow-hidden">
            ...
            <div class="card-body p-4">
                ...
                <h2 class="fw-black mb-0 text-dark counter"><?php echo e($stats['used_vouchers']); ?></h2>
            </div>
    ...
    <div class="col-sm-6 col-lg-3">
        <div class="card card-hover h-100 border-0 bg-white position-relative overflow-hidden">
            ...
            <div class="card-body p-4">
                ...
                <h2 class="fw-black mb-0 text-dark counter"><?php echo e($stats['expired_vouchers']); ?></h2>
            </div>
            <div class="position-absolute bottom-0 start-0 w-100 bg-danger" style="height: 4px;"></div>
        </div>
    </div>
    ...
    <div class="col-sm-6 col-lg-3">
        <div class="card card-hover h-100 border-0 bg-white position-relative overflow-hidden">
            ...
            <div class="card-body p-4">
                ...
                <h2 class="fw-black mb-0 text-dark">₱<span class="counter"><?php echo e($stats['today_revenue'] ?? 0); ?></span></h2>
            </div>
            <div class="position-absolute bottom-0 start-0 w-100 bg-success" style="height: 4px;"></div>
        </div>
    </div>
    ...
    <div class="col-sm-6 col-lg-3">
        <div class="card card-hover h-100 border-0 bg-white position-relative overflow-hidden">
            ...
            <div class="card-body p-4">
                ...
                <h2 class="fw-black mb-0 text-dark">₱<span class="counter"><?php echo e($stats['monthly_revenue'] ?? 0); ?></span></h2>
            </div>
            <div class="position-absolute bottom-0 start-0 w-100 bg-primary" style="height: 4px;"></div>
        </div>
    </div>
    ...
    <div class="col-sm-6 col-lg-3">
        <div class="card card-hover h-100 border-0 bg-white position-relative overflow-hidden">
            ...
            <div class="card-body p-4">
                ...
                <h2 class="fw-black mb-0 text-dark"><?php echo e($stats['total_data_usage']); ?></h2>
            </div>
            <div class="position-absolute bottom-0 start-0 w-100 bg-dark" style="height: 4px;"></div>
        </div>
    </div>
        ...
        <div class="card border-0 bg-white p-4 h-100">
            ...
            <div class="d-flex justify-content-center align-items-center h-100 pb-4">
                <canvas id="voucherChart" style="max-height: 250px;"
                    data-used="<?php echo e($stats['used_vouchers']); ?>" 
                    data-unused="<?php echo e($stats['unused_vouchers']); ?>" 
                    data-expired="<?php echo e($stats['expired_vouchers']); ?>">
                </canvas>
            </div>
        </div>
    </div>
            ...
            <div class="row g-3">
                <div class="col-6">
                    <div class="p-3 bg-light rounded-3 border">
                        ...
                        <h4 class="fw-bold mb-0"><?php echo e($stats['total_vouchers'] ?? 0); ?></h4>
                    </div>
                </div>
                <div class="col-6">
                    <div class="p-3 bg-light rounded-3 border">
                        ...
                        <h4 class="fw-bold mb-0"><?php echo e($stats['used_vouchers'] ?? 0); ?></h4>
                    </div>
                </div>
                <div class="col-6">
                    <div class="p-3 bg-light rounded-3 border">
                        ...
                        <h4 class="fw-bold mb-0"><?php echo e($stats['unused_vouchers'] ?? 0); ?></h4>
                    </div>
                </div>
                <div class="col-6">
                    <div class="p-3 bg-light rounded-3 border">
                        ...
                        <h4 class="fw-bold mb-0"><?php echo e($stats['expired_vouchers'] ?? 0); ?></h4>
                    </div>
                </div>
            </div>
        </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\radiusserver\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>