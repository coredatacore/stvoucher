        ...
        <div class="card border-0 bg-white p-4">
            <form action="<?php echo e(route('admin.settings.update')); ?>" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="system_name" value="<?php echo e($settings['branding']->where('key', 'system_name')->first()->value ?? ''); ?>" class="form-control">
                </div>
                
                <div class="mb-5">
                    <label class="form-label fw-bold text-muted small text-uppercase">Primary Color</label>
                    <input type="color" name="primary_color" value="<?php echo e($settings['branding']->where('key', 'primary_color')->first()->value ?? '#dc2626'); ?>" class="form-control form-control-color w-25" title="Choose your color">
                </div>
                ...
                <div class="row g-4 mb-4">
                    <div class="col-12 col-md-6">
                        ...
                        <input type="text" name="radius_server_ip" value="<?php echo e($settings['radius']->where('key', 'radius_server_ip')->first()->value ?? '127.0.0.1'); ?>" class="form-control">
                    </div>
                    <div class="col-12 col-md-6">
                        <label class="form-label fw-bold text-muted small text-uppercase">Global Shared Secret</label>
                        <input type="password" name="global_shared_secret" value="<?php echo e($settings['radius']->where('key', 'global_shared_secret')->first()->value ?? ''); ?>" placeholder="********" class="form-control">
                    </div>
                    <div class="col-12 col-md-6">
                        <label class="form-label fw-bold text-muted small text-uppercase">Auth Port</label>
                        <input type="number" name="auth_port" value="<?php echo e($settings['radius']->where('key', 'auth_port')->first()->value ?? '1812'); ?>" class="form-control">
                    </div>
                    <div class="col-12 col-md-6">
                        <label class="form-label fw-bold text-muted small text-uppercase">Accounting Port</label>
                        <input type="number" name="accounting_port" value="<?php echo e($settings['radius']->where('key', 'accounting_port')->first()->value ?? '1813'); ?>" class="form-control">
                    </div>
                </div>
                ...
                <div class="row g-4 mb-5">
                    <div class="col-12 col-md-6">
                        ...
                        <input type="text" name="default_prefix" value="<?php echo e($settings['voucher']->where('key', 'default_prefix')->first()->value ?? ''); ?>" class="form-control">
                    </div>
                    <div class="col-12 col-md-6">
                        <label class="form-label fw-bold text-muted small text-uppercase">Default Code Length</label>
                        <input type="number" name="default_length" value="<?php echo e($settings['voucher']->where('key', 'default_length')->first()->value ?? '8'); ?>" class="form-control">
                    </div>
                </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\radiusserver\resources\views/admin/settings/index.blade.php ENDPATH**/ ?>