    ...
    <div class="col-12 col-md-4">
        <div class="card card-hover h-100 border-0 bg-white position-relative overflow-hidden">
            ...
            <div class="card-body p-4">
                ...
                <h2 class="fw-black mb-0 text-dark">₱{{ number_format($dailySales, 2) }}</h2>
            </div>
    ...
    <div class="col-12 col-md-4">
        <div class="card card-hover h-100 border-0 bg-white position-relative overflow-hidden">
            ...
            <div class="card-body p-4">
                ...
                <h2 class="fw-black mb-0 text-dark">₱{{ number_format($weeklySales, 2) }}</h2>
            </div>
    ...
    <div class="col-12 col-md-4">
        <div class="card card-hover h-100 border-0 bg-white position-relative overflow-hidden">
            ...
            <div class="card-body p-4">
                ...
                <h2 class="fw-black mb-0 text-dark">₱{{ number_format($monthlySales, 2) }}</h2>
            </div>
            <div class="position-absolute bottom-0 start-0 w-100 bg-danger" style="height: 4px;"></div>
        </div>
    </div>
